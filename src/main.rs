...
fn main() {
    ...
    // Day 14
    assert_eq!(799, d14::part1(read_file(14)));
    assert_eq!(29076, d14::part2(read_file(14)));
    // Day 15
    assert_eq!(4883971, d15::part1(read_file(15), 2000000));
    assert_eq!(12691026767556, d15::part2(read_file(15), 4000000));
}
